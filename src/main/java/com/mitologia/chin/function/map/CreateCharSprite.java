...
@api
public class CreateCharSprite extends AbstractFunction {
	...
	public Construct exec(Target t, Environment env, Construct... args) throws ConfigRuntimeException {
		if (args[0] instanceof CArray) {
			...
			return new CString(Mapper.createKey("charsprite", ObjGenerator.charSprite(arr, t)), t);
		} else {
	...
	@Override
	public String docs() {
		return "key (array) create characterSprite";
	}
}
